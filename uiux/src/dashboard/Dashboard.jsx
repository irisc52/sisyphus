...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    storage.onChange((changes) => {
      setData(prev => ({
        ...prev,
        ...(changes.domains && { domains: changes.domains.newValue }),
        ...(changes.scrollTime && { scrollTime: changes.scrollTime.newValue }),
        ...(changes.streaks && { streaks: changes.streaks.newValue })
      }))
    })
  }, [])
